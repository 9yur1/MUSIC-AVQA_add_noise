...
#sys.path.append("/data/kyuri0924/NIPS2023/AVQA/MUSIC-AVQA") 
import shutil
import subprocess
import glob
...
def gaussian_blur(img, kernel_size=7, sigma_range=(0, 1)):
    """
    ...
    sigma (float): Standard deviation of the Gaussian kernel. Default is 0.
...
def TransformImage(img):
    ...
    #frame_tensor = gaussian_blur(frame_tensor)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--gpu", dest='gpu', type=str, default='2, 3',
