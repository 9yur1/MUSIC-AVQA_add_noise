...
def main():
    ...
    parser.add_argument(
        "--audio_dir", type=str, default='/home/kyuri0924/neurips/avqa/data/feats/vggish', help="audio dir")
    # parser.add_argument(
    #     "--video_dir", type=str, default='/home/guangyao_li/dataset/avqa/avqa-frames-1fps', help="video dir")
    parser.add_argument(
        "--video_res14x14_dir", type=str, default='/home/kyuri0924/neurips/avqa/data/feats/res18_14x14', help="res14x14 dir")
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            if (epoch % 10) == 0:
                if not os.path.exists(args.model_save_dir + args.checkpoint):
                    os.makedirs(args.model_save_dir + args.checkpoint)
